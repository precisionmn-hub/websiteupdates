...
description: When the user wants to create, import, export, or manage Bricks Builder templates — headers, footers, single post, archives, popups, sections, or full page templates. Also use when the user mentions "Bricks template," "header template," "footer template," "template conditions," "assign template site-wide," "Bricks template type," "bricks_template post type," or wants to generate a Bricks template JSON for import via the Templates system. Generate the full template JSON with id, name, title, type, elements, and global_classes.
metadata:
  version: 1.0.0
