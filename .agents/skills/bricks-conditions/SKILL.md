---
name: bricks-conditions
description: When the user wants to conditionally show or hide a Bricks element or template. Also use when the user mentions "Bricks conditions," "conditional display," "show if logged in," "hide for role," "conditional visibility in Bricks," "dynamic data condition," "post meta condition," "ACF condition in Bricks," "device condition," or wants to build compound AND/OR logic for element visibility.
metadata:
  version: 1.0.0
