---
name: bricks-builder-permissions
description: When the user wants to control who can access or edit in the Bricks Builder. Also use when the user mentions "Bricks permissions," "builder access," "restrict Bricks to admins," "builder capabilities," "custom role for Bricks," "bricks_edit_content capability," "lock Bricks elements from client," or wants per-role control over which Bricks features are editable.
metadata:
  version: 1.0.0
